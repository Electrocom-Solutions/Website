            ...
            <div className="space-y-6">
              <div className="backdrop-blur-xl bg-white/90 dark:bg-gray-800/80 p-8 rounded-3xl shadow-2xl border-2 border-white/30 dark:border-gray-700/40 backdrop-saturate-150">
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4 group">
                    <div className="backdrop-blur-xl bg-primary-100/80 dark:bg-primary-900/40 p-4 rounded-xl group-hover:bg-primary-200/80 dark:group-hover:bg-primary-900/60 transition-colors duration-300 transform group-hover:scale-110 border border-primary-200/50 dark:border-primary-800/50">
              ...
              <div className="backdrop-blur-xl bg-white/90 dark:bg-gray-800/80 p-8 rounded-3xl shadow-2xl border-2 border-white/30 dark:border-gray-700/40 backdrop-saturate-150">
                ...
                <div className="flex space-x-4">
                  <a 
                    href="#" 
                    className="group bg-blue-600 text-white p-4 rounded-xl hover:bg-blue-700 dark:hover:bg-blue-500 transition-all duration-300 transform hover:scale-110 hover:shadow-lg"
                    aria-label="LinkedIn"
                  >
                  ...
                  <a 
                    href="#" 
                    className="group bg-blue-800 text-white p-4 rounded-xl hover:bg-blue-900 dark:hover:bg-blue-700 transition-all duration-300 transform hover:scale-110 hover:shadow-lg"
                    aria-label="Facebook"
                  >
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a 
                    href="#" 
                    className="group bg-gradient-to-br from-purple-600 to-pink-600 text-white p-4 rounded-xl hover:from-purple-700 hover:to-pink-700 transition-all duration-300 transform hover:scale-110 hover:shadow-lg"
